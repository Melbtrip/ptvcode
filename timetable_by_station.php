...
$stop_number = "1185"; // Default stop number
$stop_name = "Stony Point Station"; // Default stop name
...
<div style="width: 70%; float: right;">
    <table>
        <tr>
            ...
            <th colspan="5" class="sign"><h2><?php echo $stop_name; ?></h2></th>
        </tr>
        <tr>
            <th>Route Name</th>
            <th>Route ID</th>
...
$line_stopurl = "/v3/stops/route/".$route_number."/route_type/0?direction_id=5";
...
foreach ($line_stops['stops'] as $stop) {
    ...
    echo '</form>';
    echo '<td>' . $stop['stop_ticket']['zone'] . '</td>';
    echo '</td>';
    echo '</tr>';
}
...
<h1>Current Stop Number: <?php echo $_SESSION['stop_number']; ?></h1>
